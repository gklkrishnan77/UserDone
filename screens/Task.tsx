...
import { View, Text, ScrollView, TextInput, TouchableHighlight,StyleSheet, ImageBackground} from 'react-native';
  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
      ...
      <View style={{ height: '100%', width: '100%', alignItems: 'center' }}>
        <View>
          <Text style={{ fontSize: 50, textAlign: 'center', color: 'rgb(250,250,250)', padding: 10 }}>Task To Client Registration</Text>
        </View>
        <ScrollView style={{ display: 'flex' }} showsVerticalScrollIndicator={false}>
          <View style={{ backgroundColor: 'rgba(0,0,0,0.2)', overflow: 'hidden', margin: 25, padding: 35, borderRadius: 25, justifyContent: 'space-around', }}>
            <View style={styles.row}>
              ...
              <TextInput style={styles.textbox} placeholder={'ClientName'} />
            </View>
            <View style={styles.row}>
              <Ionicons name='business-sharp' size={20} color='rgb(218,165,32)' />
              <TextInput style={styles.textbox} placeholder={'ClientCompanyName'} />
            </View>
            <View style={styles.row}>
            ...
            <View style={styles.row}>
              ...
              <TextInput style={styles.textbox} placeholder={'ClientCompanyAddress'} multiline={true} numberOfLines={3} />
            </View>
            <View style={styles.row}>
            ...
            <View style={styles.row}>
              <Ionicons name='clipboard' size={20} color='rgb(218,165,32)' />
              <TextInput style={styles.textbox} placeholder={'Task Description'} multiline={true} numberOfLines={3} />
            </View>
            <View style={styles.row}>
              <TouchableHighlight>
